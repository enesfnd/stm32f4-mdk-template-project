...
SD_Error SD_Init(void)
{
	...
	gpio_af_pp_up_init(GPIOC, GPIO_Pin_8|GPIO_Pin_9|GPIO_Pin_10|GPIO_Pin_11|GPIO_Pin_12);//SDIO_D0,SDIO_D1,SDIO_D2,SDIO_D3,SDIO_CK
	gpio_af_pp_up_init(GPIOD, GPIO_Pin_2);//SDIO_CMD
